    ...
    {/* <div className="mb-6">
      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <h3 className="text-lg font-semibold text-gray-700">Team Goals</h3>
        </div>
      ...
      {expandedSection === 'team' && (
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
          {[1, 2].map((goal) => (
            <div key={goal} className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200">
              <h4 className="font-semibold text-gray-800 mb-2">Team Goal {goal}</h4>
              <p className="text-gray-600 text-sm">Description of manager-assigned team goal {goal}.</p>
              <div className="mt-3 flex items-center justify-between">
                <span className="text-sm text-green-500 font-medium">Status: In Progress</span>
    ...
    {/* <div className="mb-2">
      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <h3 className="text-lg font-semibold text-gray-700">Self-Assigned Goals</h3>
        </div>
      ...
      {expandedSection === 'employee' && (
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
          {[1, 2].map((goal) => (
            <div key={goal} className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200">
              <h4 className="font-semibold text-gray-800 mb-2">Personal Goal {goal}</h4>
              <p className="text-gray-600 text-sm">Description of self-assigned goal {goal}.</p>
              <div className="mt-3 flex items-center justify-between">
                <span className="text-sm text-purple-500 font-medium">Status: Pending Review</span>
